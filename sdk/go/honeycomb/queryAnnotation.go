...
// The dataset this query is added to.
func (o QueryAnnotationOutput) Dataset() pulumi.StringOutput {
	return o.ApplyT(func(v *QueryAnnotation) pulumi.StringOutput { return v.Dataset }).(pulumi.StringOutput)
}

// The description for the query annotation.
func (o QueryAnnotationOutput) Description() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *QueryAnnotation) pulumi.StringPtrOutput { return v.Description }).(pulumi.StringPtrOutput)
}

// The name of the query annotation that will display in the Honeycomb UI.
func (o QueryAnnotationOutput) Name() pulumi.StringOutput {
	return o.ApplyT(func(v *QueryAnnotation) pulumi.StringOutput { return v.Name }).(pulumi.StringOutput)
}

// The ID of the query that the annotation will be created on. Note that a query can have more than one annotation.
func (o QueryAnnotationOutput) QueryId() pulumi.StringOutput {
	return o.ApplyT(func(v *QueryAnnotation) pulumi.StringOutput { return v.QueryId }).(pulumi.StringOutput)
}
